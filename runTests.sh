...
time differentialBindingAffinity_multipleSNPs  -o examples/SNEEP_output_open_chromatin_/ -p 0.5 -c 0.001 -n 10 -b necessaryInputFiles/frequency.txt -x necessaryInputFiles/transition_matrix.txt -f ENCFF199VHV.bed examples/combined_Jaspar2022_Hocomoco_Kellis_human_transfac.txt  examples/SNPs_EFO_0000612_myocardial_infarction.bed ${genome} necessaryInputFiles/estimatedScalesPerMotif_1.9.txt

## Example 3: Associate the SNPs, which significantly affect the binding behavior of a TF to their target genes
time differentialBindingAffinity_multipleSNPs -o examples/SNEEP_output_REM_PRO_HiC_/ -p 0.5 -c 0.001 -n 10  -b necessaryInputFiles/frequency.txt -x necessaryInputFiles/transition_matrix.txt  -r ${interactions} -g ensemblID_GeneName.txt  examples/combined_Jaspar2022_Hocomoco_Kellis_human_transfac.txt  examples/SNPs_EFO_0000612_myocardial_infarction.bed ${genome} necessaryInputFiles/estimatedScalesPerMotif_1.9.txt

## Example 4: Compute a proper random background control and highlight the cell-ype specific TFs
time differentialBindingAffinity_multipleSNPs -o examples/SNEEP_output_background_sampling_/ -p 0.5 -c 0.001 -b necessaryInputFiles/frequency.txt -x necessaryInputFiles/transition_matrix.txt  -n 20 -j 10 -k ${dbSNP} -l 2 -q 0 -r ${interactions} -g ensemblID_GeneName.txt  examples/combined_Jaspar2022_Hocomoco_Kellis_human_transfac.txt  examples/SNPs_EFO_0000612_myocardial_infarction.bed ${genome} necessaryInputFiles/estimatedScalesPerMotif_1.9.txt
